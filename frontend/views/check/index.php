    ...
    <div class="body_main">
        ...
        <div class="tj_alert tj_ddd">
            <div class="al_tit">
                ...
                <a href="#" class="albtn_right">确定</a>
            </div>
            <div class="alsx_body swiper-container tj_swp">
                <div class="dwwo">&nbsp;</div>
                <ul class="swiper-wrapper">
                    <li class="swiper-slide">下滑选择推荐</li>
                    <li class="swiper-slide">最新</li>
                    <li class="swiper-slide">评分最高</li>
                    <li class="swiper-slide">最新</li>
                    <li class="swiper-slide">评分最高</li>
        ...
        <div class="tj_alert dp_ddd">
            ...
            <div class="alsx_body swiper-container dp_swp">
                ...
                <ul class="swiper-wrapper">
                    ...
                    <li class="swiper-slide">威海卫</li>
                    <li class="swiper-slide">家之味</li>
                    <li class="swiper-slide">金钱豹</li>
                    <li class="swiper-slide">永和</li>
        ...
        <div class="tj_alert tm_ddd">
            ...
            <div class="alsx_body swiper-container tm_swp">
                <div class="dwwo">&nbsp;</div>
                <ul class="swiper-wrapper">
                    <li class="swiper-slide">下滑选择时间</li>
                    <li class="swiper-slide">日</li>
                    <li class="swiper-slide">周</li>
                    <li class="swiper-slide">月</li>
                    <li class="swiper-slide">季</li>
                    <li class="swiper-slide">年</li>
